...
import com.happening.chat.fragments.Bt2Controls;
import com.happening.chat.fragments.Bt4Controls;
import com.happening.chat.fragments.BtStatus;
import com.happening.chat.fragments.ChatFragment;
import com.happening.chat.fragments.DBTestFragment;
import com.happening.chat.fragments.MainFragment;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.main) {
            if (this.mainFragment == null) {
                this.mainFragment = getFragmentManager().findFragmentByTag(this.TAG_FRAGMENT_MAIN);
                if (this.mainFragment == null) {
            ...
            if (this.chatFragment == null) {
                this.chatFragment = getFragmentManager().findFragmentByTag(this.TAG_FRAGMENT_CHAT);
                if (this.chatFragment == null) {
            ...
            if (this.bt4ControlsFragment == null) {
                this.bt4ControlsFragment = getFragmentManager().findFragmentByTag(this.TAG_FRAGMENT_BT4CONTROLS);
                if (this.bt4ControlsFragment == null) {
            ...
            if (this.bt2ControlsFragment == null) {
                this.bt2ControlsFragment = getFragmentManager().findFragmentByTag(this.TAG_FRAGMENT_BT2CONTROLS);
                if (this.bt2ControlsFragment == null) {
            ...
            if (this.btStatusFragment == null) {
                this.btStatusFragment = getFragmentManager().findFragmentByTag(this.TAG_FRAGMENT_BTSTATUS);
                if (this.btStatusFragment == null) {
            ...
            if (this.dbTestFragment == null) {
                this.dbTestFragment = getFragmentManager().findFragmentByTag(this.TAG_FRAGMENT_DB_TEST);
                if (this.dbTestFragment == null) {
